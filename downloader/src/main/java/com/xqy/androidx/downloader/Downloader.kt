...
class Downloader private constructor() {
    ...
    fun multiDownload( taskUrls:MutableList<String>, filenames:MutableList<String>,
        ...
        GlobalScope.async {
            repeat(taskUrls.size){index->
                val taskUrl = taskUrls[index]
    ...
    private fun realDownload(mTask: Task){
        mOkHttpClient.newCall(mTask.request)
